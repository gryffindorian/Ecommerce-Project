...
export default function EndDeals() {
  return (
              ...
              <div className="product-img-action-wrap">
                <div className="product-img">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/banner/banner-5.png"
                      alt=""
                    />
                  </a>
                </div>
            ...
            >
              <div className="product-img-action-wrap">
                <div className="product-img">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/banner/banner-6.png"
                      alt=""
                    />
                  </a>
                </div>
            ...
            >
              <div className="product-img-action-wrap">
                <div className="product-img">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/banner/banner-7.png"
                      alt=""
                    />
                  </a>
                </div>
            ...
            >
              <div className="product-img-action-wrap">
                <div className="product-img">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/banner/banner-8.png"
                      alt=""
                    />
                  </a>
                </div>
