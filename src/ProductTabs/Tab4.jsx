              ...
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    ...
                    src="template/assets/imgs/shop/product-6-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-6-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-4-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-4-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-1-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-1-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-11-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-11-2.jpg"
                    alt=""
                  />
                </a>
              </div>
