              ...
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    ...
                    src="template/assets/imgs/shop/product-12-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-12-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-13-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-13-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-14-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-14-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-15-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-15-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-16-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-16-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-5-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-5-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-8-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-8-2.jpg"
                    alt=""
                  />
                </a>
              </div>
            ...
            <div className="product-img-action-wrap">
              <div className="product-img product-img-zoom">
                <a href="shop-product-right.html">
                  <img
                    className="default-img"
                    src="template/assets/imgs/shop/product-10-1.jpg"
                    alt=""
                  />
                  <img
                    className="hover-img"
                    src="template/assets/imgs/shop/product-10-2.jpg"
                    alt=""
                  />
                </a>
              </div>
