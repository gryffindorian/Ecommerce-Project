        ...
        <div className="carausel-10-columns-cover position-relative">
          <div className="carausel-10-columns" id="carausel-10-columns">
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-13.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-12.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-11.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-9.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-3.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-1.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-2.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-4.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-5.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-14.png" alt="" />
                </a>
              </figure>
              <h6>
            ...
            >
              <figure className="img-hover-scale overflow-hidden">
                <a href="shop-grid-right.html">
                  <img src="template/assets/imgs/shop/cat-15.png" alt="" />
                </a>
              </figure>
              <h6>
