              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-1.jpg"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="product-list-small animated animated">
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-5.jpg"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-6.jpg"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="product-list-small animated animated">
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-7.jpg"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-8.jpg"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-9.jpg"
                      alt=""
                    />
                  </a>
                </figure>
            ...
            <div className="product-list-small animated animated">
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-10.jpg"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-11.jpg"
                      alt=""
                    />
                  </a>
                </figure>
              ...
              <article className="row align-items-center hover-up">
                <figure className="col-md-4 mb-0">
                  <a href="shop-product-right.html">
                    <img
                      src="template/assets/imgs/shop/thumbnail-12.jpg"
                      alt=""
                    />
                  </a>
                </figure>
