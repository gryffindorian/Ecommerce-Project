    ...
    <main className="main">
      ...
      <div className="container mb-30">
        <div
          ...
          style={{
            backgroundImage: "url(assets/imgs/vendor/vendor-header-bg.png)",
          }}
        >
          <div className="archive-header-3-inner">
            ...
            <div className="vendor-content">
              ...
              <h3 className="mb-5 text-white">
                <a className="text-white" href="vendor-details-1.html">
                  Nest Food.,Ltd
                </a>
              </h3>
                ...
                <div className="col-lg-4">
                  <div className="vendor-des mb-15">
                    <p className="font-sm text-white">
                      ...
                      good that it's Good Chef. This brand made Lionto's list of
                      the most popular grocery brands across the country.
                    </p>
                  </div>
                </div>
        ...
        <div className="row flex-row-reverse">
          ...
          <div className="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div className="banner-img mb-30">
